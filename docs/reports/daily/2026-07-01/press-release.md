...
*Washington, D.C. -- July 1, 2026* -- A daily scan of 13 of the most-visited U.S. government websites found 28 accessibility barriers across 13 URLs today. The most common issues include Document Structure Navigation, Digital Motor Access, and Primary Content Identification.
...
|-----------------|---------------------|--------------------------|
| Without Perception of Color | 25,136 | ~1,081 |
| Limited Reach and Strength | 16,952 | ~983 |
| Limited Vision | 28,142 | ~675 |
| Limited Manipulation | 19,520 | ~429 |
| Without Vision | 19,520 | ~195 |
| Without Hearing | 19,520 | ~59 |

*Total page loads across all scanned URLs today: 165,204*
...
- [View full interactive report](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-07-01/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-07-01/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-07-01/axe-findings.csv)

---

*Generated by [Daily NSF](https://github.com/mgifford/daily-nsf) | Source: Digital Analytics Program | Methodology: Lighthouse + axe-core | Date: 2026-07-01*
