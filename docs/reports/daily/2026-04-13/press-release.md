...
# U.S. Government Website Accessibility Report: April 13, 2026

*Washington, D.C. -- April 13, 2026* -- A daily scan of 11 of the most-visited U.S. government websites found 29 accessibility barriers across 11 URLs today. The most common issues include Primary Content Identification, Visual Information Access, and Color-Independent Link Identification.
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 79,979 | ~4,639 |
| Without Perception of Color | 80,711 | ~3,471 |
| Limited Vision | 82,236 | ~1,974 |
| Limited Manipulation | 81,620 | ~1,796 |
| Without Vision | 81,620 | ~816 |
| Without Hearing | 81,620 | ~245 |

*Total page loads across all scanned URLs today: 174,049*
...
- [View full interactive report](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-13/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-13/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-13/axe-findings.csv)

---

*Generated by [Daily NSF](https://github.com/mgifford/daily-nsf) | Source: Digital Analytics Program | Methodology: Lighthouse + axe-core | Date: 2026-04-13*
