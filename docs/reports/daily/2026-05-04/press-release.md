...
*Washington, D.C. -- May 4, 2026* -- A daily scan of 11 of the most-visited U.S. government websites found 25 accessibility barriers across 11 URLs today. The most common issues include Document Structure Navigation, Color-Independent Link Identification, and Digital Motor Access.
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 5,465 | ~317 |
| Without Perception of Color | 5,850 | ~252 |
| Limited Vision | 7,394 | ~177 |
| Limited Manipulation | 6,609 | ~145 |
| Without Vision | 6,609 | ~66 |
| Without Hearing | 6,609 | ~20 |

*Total page loads across all scanned URLs today: 124,574*
...
- [View full interactive report](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-05-04/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-05-04/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-05-04/axe-findings.csv)

---

*Generated by [Daily NSF](https://github.com/mgifford/daily-nsf) | Source: Digital Analytics Program | Methodology: Lighthouse + axe-core | Date: 2026-05-04*
