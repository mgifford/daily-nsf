...
*Washington, D.C. -- April 8, 2026* -- A daily scan of 12 of the most-visited U.S. government websites found 32 accessibility barriers across 12 URLs today. The most common issues include Primary Content Identification, Document Structure Navigation, and Color-Independent Link Identification.
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 25,311 | ~1,468 |
| Without Perception of Color | 26,627 | ~1,145 |
| Limited Vision | 31,344 | ~752 |
| Limited Manipulation | 30,274 | ~666 |
| Without Vision | 30,274 | ~303 |
| Without Hearing | 30,274 | ~91 |

*Total page loads across all scanned URLs today: 219,762*
...
- [View full interactive report](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-08/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-08/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-08/axe-findings.csv)

---

*Generated by [Daily NSF](https://github.com/mgifford/daily-nsf) | Source: Digital Analytics Program | Methodology: Lighthouse + axe-core | Date: 2026-04-08*
