...
*Washington, D.C. -- April 20, 2026* -- A daily scan of 11 of the most-visited U.S. government websites found 31 accessibility barriers across 11 URLs today. The most common issues include Color-Independent Link Identification, Digital Motor Access, and Primary Content Identification.
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 8,686 | ~504 |
| Without Perception of Color | 9,475 | ~407 |
| Limited Vision | 10,727 | ~257 |
| Limited Manipulation | 10,041 | ~221 |
| Without Vision | 10,041 | ~100 |
| Without Hearing | 10,041 | ~30 |

*Total page loads across all scanned URLs today: 82,373*
...
- [View full interactive report](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-20/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-20/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-20/axe-findings.csv)

---

*Generated by [Daily NSF](https://github.com/mgifford/daily-nsf) | Source: Digital Analytics Program | Methodology: Lighthouse + axe-core | Date: 2026-04-20*
