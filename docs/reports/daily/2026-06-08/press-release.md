...
*Washington, D.C. -- June 8, 2026* -- A daily scan of 12 of the most-visited U.S. government websites found 30 accessibility barriers across 12 URLs today. The most common issues include Color-Independent Link Identification, Digital Motor Access, and Primary Content Identification.
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 11,637 | ~675 |
| Without Perception of Color | 12,545 | ~539 |
| Limited Vision | 14,149 | ~340 |
| Limited Manipulation | 12,958 | ~285 |
| Without Vision | 12,958 | ~130 |
| Without Hearing | 12,958 | ~39 |

*Total page loads across all scanned URLs today: 65,521*
...
- [View full interactive report](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-06-08/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-06-08/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-06-08/axe-findings.csv)

---

*Generated by [Daily NSF](https://github.com/mgifford/daily-nsf) | Source: Digital Analytics Program | Methodology: Lighthouse + axe-core | Date: 2026-06-08*
