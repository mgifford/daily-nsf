...
*Washington, D.C. -- May 31, 2026* -- A daily scan of 11 of the most-visited U.S. government websites found 30 accessibility barriers across 11 URLs today. The most common issues include Color-Independent Link Identification, Digital Motor Access, and Primary Content Identification.
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 8,165 | ~474 |
| Without Perception of Color | 8,859 | ~381 |
| Limited Vision | 10,260 | ~246 |
| Limited Manipulation | 9,100 | ~200 |
| Without Vision | 9,100 | ~91 |
| Without Hearing | 9,100 | ~27 |

*Total page loads across all scanned URLs today: 50,091*
...
- [View full interactive report](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-05-31/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-05-31/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-05-31/axe-findings.csv)

---

*Generated by [Daily NSF](https://github.com/mgifford/daily-nsf) | Source: Digital Analytics Program | Methodology: Lighthouse + axe-core | Date: 2026-05-31*
