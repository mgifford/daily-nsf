...
# U.S. Government Website Accessibility Report: April 3, 2026

*Washington, D.C. -- April 3, 2026* -- A daily scan of 11 of the most-visited U.S. government websites found 31 accessibility barriers across 11 URLs today. The most common issues include Color-Independent Link Identification, Digital Motor Access, and Primary Content Identification.
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 42,842 | ~2,485 |
| Without Perception of Color | 44,077 | ~1,895 |
| Limited Vision | 46,026 | ~1,105 |
| Limited Manipulation | 45,002 | ~990 |
| Without Vision | 45,002 | ~450 |
| Without Hearing | 45,002 | ~135 |

*Total page loads across all scanned URLs today: 153,708*
...
### 1. `link-in-text-block`: Color-Independent Link Identification
...
- [View full interactive report](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-03/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-03/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-03/axe-findings.csv)

---

*Generated by [Daily NSF](https://github.com/mgifford/daily-nsf) | Source: Digital Analytics Program | Methodology: Lighthouse + axe-core | Date: 2026-04-03*
