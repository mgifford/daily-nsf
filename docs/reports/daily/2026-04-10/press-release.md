...
*Washington, D.C. -- April 10, 2026* -- A daily scan of 11 of the most-visited U.S. government websites found 31 accessibility barriers across 11 URLs today. The most common issues include Color-Independent Link Identification, Digital Motor Access, and Primary Content Identification.
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 29,575 | ~1,715 |
| Without Perception of Color | 30,980 | ~1,332 |
| Limited Vision | 35,669 | ~856 |
| Limited Manipulation | 34,457 | ~758 |
| Without Vision | 34,457 | ~345 |
| Without Hearing | 34,457 | ~103 |

*Total page loads across all scanned URLs today: 231,807*
...
- [View full interactive report](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-10/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-10/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-nsf/docs/reports/daily/2026-04-10/axe-findings.csv)

---

*Generated by [Daily NSF](https://github.com/mgifford/daily-nsf) | Source: Digital Analytics Program | Methodology: Lighthouse + axe-core | Date: 2026-04-10*
