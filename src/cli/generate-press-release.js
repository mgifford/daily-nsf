 ...
 * accessibility barriers found in today's daily NSF scan.
 *
...
const BASE_REPORT_URL = 'https://mgifford.github.io/daily-nsf/docs/reports/daily';
...
export function buildPressRelease(report, axeData, options = {}) {
  ...
  lines.push('');
  lines.push(
    `*Generated by [Daily NSF](https://github.com/mgifford/daily-nsf) | ` +
