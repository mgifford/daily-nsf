...
| OpenAI GPT-5 (Codex) | (current) | Implemented report Definition-of-Done work: added contract/integration tests for artifact hash+byte sync and same-date rerun idempotency, and documented release Definition of Done in `docs/reports/operations.md` |
